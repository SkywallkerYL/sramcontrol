...
//   DataCollectorInst.io.unpackedNumFifoRead <> ScaterDataNumFifo.map(_.io.fifo.fiforead)
//   DataCollectorInst.io.unpackedLenFifoRead <> ScaterDataLenFifo.map(_.io.fifo.fiforead)
//   DataCollectorInst.io.unpackedAddrFifoRead <> ScaterAddrFifo.map(_.io.fifo.fiforead)
//   DataCollectorInst.io.ArbiterData <> io.ArbiterData
//   DataCollectorInst.io.ArbiterAddr <> io.ArbiterAddr
